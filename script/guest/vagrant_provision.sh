...
cp /vagrant/script/data/wgetrc .wgetrc
...
if ! [ -e "/vagrant/building" ]; then
    ...
    cp /vagrant/script/data/torrc_global /etc/tor/torrc
    mkdir -p /home/vagrant/.hiddenservice
    cp /vagrant/script/data/torrc_local /home/vagrant/.hiddenservice/torrc
...
su vagrant -c /vagrant/script/guest/setup.sh
