...
# When using Vagrant.
vagrant)
  vagrant ssh -c "/vagrant/script/menuconfig.sh \"$1\""
  ;;
...
docker)
  ...
  ssh -oStrictHostKeyChecking=no vagrant@127.0.0.1 -p 22222 -i ./script/builder-keys/ssh.priv /vagrant/script/menuconfig.sh \"$1\"
  ;;
